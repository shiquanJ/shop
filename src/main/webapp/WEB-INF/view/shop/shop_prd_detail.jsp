...
<%@include file="../common/header.jsp" %>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 lightbox-gallery product-gallery">
                        ...
                        <div class="product-description mt-9">
                   ...
                   <div class="col-lg-6 ps-lg-10">
                       <div class="product-detail pt-4 pt-lg-0">
                           ...
                           <div class="rating-star text small pb-4">
                            ...
                            <div class="count-down count-down-02 mt-6 mb-3" data-countdown="January 01, 2023 15:00:00"></div>
    ...
    <!-- End Footer -->
    <script src="../assets/js/shop/shop_prd_detail.js?${js_timer}"></script>	