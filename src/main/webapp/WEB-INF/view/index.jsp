            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 my-3">
                    ...
                    <address class="white-link mb-4">
                        <p class="text-white-85 mb-2">
                            3909 Witmer Rd,Niagara Falls,<br/>NY 14305,United States
                        </p>
                        <p class="mb-2">
                            <a class="border-bottom border-secondary" href="mailto:Fancyshopping@gmail.com">Fancyshopping@gmail.com</a>
                        </p>
                        <p class="mb-2">
                            <a class="border-bottom border-secondary" href="tel:123-456-789">tel:123-456-789</a>
                        </p>
                    </address>
                ...
                <div class="col-sm-6 col-lg-2 my-3">
                    <h6 class="text-white text-uppercase mb-5">Account </h6>
                ...
                <div class="col-sm-6 col-lg-2 my-3">
                    ...
                    <ul class="list-unstyled white-link footer-link-1 m-0">
                        ...
                        <li class="pb-2">
                            <a href="account-tickets.html">Tickets</a>
                        </li>
                        <li class="pb-2">
                ...
                <div class="col-sm-6 col-lg-4 my-3">
                    ...
                    <p class="text-white-85">Fancy Shopping trademark,Model.</p>
                    <form>
                        <div class="d-flex flex-column flex-md-row mb-2">
                            <input type="email" class="form-control me-md-2 mb-2 mb-md-0" placeholder="Enter your username">
                            <button class="btn btn-primary flex-shrink-0" type="button">Get Started</button>
                        </div>
                        <p class="text-white-85 m-0">New UI kits or big discounts. Never spam.</p>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-md-start py-1">
                    <p class="m-0 text-white-85">
                        Copyright,2021 © Fancy Shopping - HTML Ecommerce Template,<br/>
                        Powered by <a href="http://www.bootstrapmb.com" target="_blank" class="text-reset">AVS Technolabs</a>
                    </p>
                </div>
                <div class="col-md-6 text-center text-md-end py-1">
                    <img src="assets/img/payments.png" title="" alt="">
                </div>
            </div>
        </div>
    </div>
