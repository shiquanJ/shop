...
!function(d, e) {
    ...
    function y(f) {
        var g = arguments.length <= 1 || void 0 === arguments[1] ? !1 : arguments[1]
          , h = arguments.length <= 2 || void 0 === arguments[2] ? !1 : arguments[2]
          , i = arguments.length <= 3 || void 0 === arguments[3] ? null : arguments[3]
          , j = void 0;
        return null != document.createEvent ? (j = document.createEvent("CustomEvent"),
        j.initCustomEvent(f, g, h, i)) : null != document.createEventObject ? (j = document.createEventObject(),
        j.eventType = f) : j.eventName = f,
        j
    }
    function z(c, d) {
        null != c.dispatchEvent ? c.dispatchEvent(d) : d in (null != c) ? c[d]() : "on" + d in (null != c) && c["on" + d]()
    }
    function A(d, e, f) {
        null != d.addEventListener ? d.addEventListener(e, f, !1) : null != d.attachEvent ? d.attachEvent("on" + e, f) : d[e] = f
    }
    function B(d, e, f) {
        null != d.removeEventListener ? d.removeEventListener(e, f, !1) : null != d.detachEvent ? d.detachEvent("on" + e, f) : delete d[e]
    }
    function C() {
    ...
    var D, E, F = function() {
        ...
        return function(a, e, f) {
            return e && b(a.prototype, e),
            f && b(a, f),
            a
        }
    }(), G = window.WeakMap || window.MozWeakMap || function() {
        function b() {
            u(this, b),
            this.keys = [],
            this.values = []
        ...
        b
    }(), H = window.MutationObserver || window.WebkitMutationObserver || window.MozMutationObserver || (E = D = function() {
        function b() {
            u(this, b),
    ...
    D.notSupported = !0,
    E), I = window.getComputedStyle || function(c) {
        var d = /(\-([a-z]){1})/g;
        return {
            getPropertyValue: function(a) {
                "float" === a && (a = "styleFloat"),
                d.test(a) && a.replace(d, function(e, f) {
    ...
    , J = function() {
        ...
        return F(b, [{
            ...
            value: function() {
                ...
                v(document.readyState, ["interactive", "complete"]) ? this.start() : A(document, "DOMContentLoaded", this.start),
                this.finished = []
            }
        }, {
            key: "start",
            value: function() {
                ...
                if (this.disabled() || (A(this.config.scrollContainer || window, "scroll", this.scrollHandler),
            ...
            value: function() {
                this.stopped = !0,
                B(this.config.scrollContainer || window, "scroll", this.scrollHandler),
            ...
            key: "doSync",
            value: function(d) {
                if ("undefined" != typeof d && null !== d || (d = this.element),
                1 === d.nodeType) {
                    d = d.parentNode || d;
                    for (var f = d.querySelectorAll("." + this.config.boxClass), g = 0; g < f.length; g++) {
                        var h = f[g];
                        v(h, this.all) || (this.boxes.push(h),
                        this.all.push(h),
                        this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(h, !0),
                        this.scrolled = !0)
                    }
                }
            }
            ...
            value: function(c) {
                if (c.type.toLowerCase().indexOf("animationend") >= 0) {
                    ...
                    d.className = d.className.replace(this.config.animateClass, "").trim()
                }
            }
        }, {
            key: "customStyle",
            value: function(f, g, h, i, j) {
                ...
                h && this.vendorSet(f.style, {
                    animationDuration: h
                }),
                i && this.vendorSet(f.style, {
                    animationDelay: i
                }),
                j && this.vendorSet(f.style, {
            ...
            key: "vendorCSS",
            value: function(g, h) {
                for (var i = I(g), j = i.getPropertyCSSValue(h), k = 0; k < this.vendors.length; k++) {
                    var l = this.vendors[k];
