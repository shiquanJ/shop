    ...
    a.fn.meanmenu = function(c) {
        ...
        return this.each(function() {
            var O = c.meanMenuTarget
              ...
              , S = c.removeElements
              , z = !1;
            (navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/Blackberry/i) || navigator.userAgent.match(/Windows Phone/i)) && (z = !0),
            ...
            var ab = ""
              , ad = function() {
                if ("center" === Z) {
                    ...
                    z ? jQuery(".meanmenu-reveal").animate({
                        left: g
            ...
            var N = ""
              ...
              , k = function() {
                ...
                if (R >= b) {
                    ...
                    jQuery(".mean-container").prepend('<div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="' + f + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
                    var g = jQuery(O).html();
                    jQuery(".mean-nav").html(g),
                    U && jQuery("nav.mean-nav ul, nav.mean-nav ul *").each(function() {
                    ...
                    H ? B ? (jQuery(".mean-nav ul ul").each(function() {
                    ...
                    jQuery(".mean-expand").on("click", function(h) {
                        h.preventDefault(),
                        jQuery(this).hasClass("mean-clicked") ? (jQuery(this).text(ae),
