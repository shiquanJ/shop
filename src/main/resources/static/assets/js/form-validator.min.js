...
+function(f) {
    function g(a) {
        return this.each(function() {
            ...
            (k || "destroy" != a) && (k || b.data("bs.validator", k = new i(this,d)),
            "string" == typeof a && k[a]())
        })
    }
    ...
    i.prototype.validateInput = function(a) {
        ...
        this.$element.trigger(a = f.Event("validate.bs.validator", {
            relatedTarget: k[0]
        })),
    ...
    i.prototype.runValidators = function(a) {
        ...
        !k.length && a.val() && a.data("remote") ? this.defer(a, function() {
            var b = {};
            b[a.attr("name")] = a.val(),
    ...
    i.prototype.showErrors = function(a) {
        ...
        this.defer(a, function() {
            ...
            void 0 === c.data("bs.validator.originalContent") && c.data("bs.validator.originalContent", c.html()),
            c.empty().append(l),
            b.addClass("has-error"),
            k.length && k.removeClass(this.options.feedback.success) && k.addClass(this.options.feedback.error) && b.removeClass("has-success"))
        })
    }
    ,
    ...
    i.prototype.defer = function(a, d) {
        ...
        this.options.delay ? (window.clearTimeout(a.data("bs.validator.timeout")),
