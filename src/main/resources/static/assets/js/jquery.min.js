...
!function(a, b) {
    ...
    b4.extend = b4.fn.extend = function() {
        ...
        b = arguments[k] || {},
        k++),
        "object" == typeof b || bs(b) || (b = {}),
        k === p && (b = this,
        k--); k < p; k++) {
            if (null != (c = arguments[k])) {
                for (m in c) {
                    j = c[m],
                    "__proto__" !== m && b !== j && (f && j && (b4.isPlainObject(j) || (d = Array.isArray(j))) ? (g = b[m],
                    h = d && !Array.isArray(g) ? [] : d || b4.isPlainObject(g) ? g : {},
                    d = !1,
                    b[m] = b4.extend(f, h, j)) : void 0 !== j && (b[m] = j))
                }
            }
        }
        return b
    ...
    b4.extend({
        ...
        makeArray: function(a, c) {
            var b = c || [];
            return null != a && (bL(Object(a)) ? b4.merge(b, "string" == typeof a ? [a] : a) : cg.call(b, a)),
            b
        },
    ...
    "function" == typeof Symbol && (b4.fn[Symbol.iterator] = b9[Symbol.iterator]),
    b4.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function(a, b) {
        bz["[object " + b + "]"] = b.toLowerCase()
    });
    var aB = function(du) {
        var c2, cZ, cS, dx, dg, dc, c6, c9, dV, dP, dn, dM, cW, ct, c3, dS, dI, cV, d1, dJ = "sizzle" + 1 * new Date, dA = du.document, dl = 0, dF = 0, dr = dR(), dY = dR(), cQ = dR(), dv = dR(), c0 = function(a, b) {
            return a === b && (dn = !0),
            0
        }, dj = {}.hasOwnProperty, dL = [], dD = dL.pop, dp = dL.push, dd = dL.push, dy = dL.slice, dB = function(a, d) {
            ...
            return -1
        }, dG = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ds = "[\\x20\\t\\r\\n\\f]", dh = "(?:\\\\[\\da-fA-F]{1,6}" + ds + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", dW = "\\[" + ds + "*(" + dh + ")(?:" + ds + "*([*^$|!~]?=)" + ds + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + dh + "))|)" + ds + "*\\]", c7 = ":(" + dh + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + dW + ")*)|.*)\\)|)", cT = new RegExp(ds + "+","g"), at = new RegExp("^" + ds + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ds + "+$","g"), bt = new RegExp("^" + ds + "*," + ds + "*"), d4 = new RegExp("^" + ds + "*([>+~]|" + ds + ")" + ds + "*"), dQ = new RegExp(ds + "|>"), dZ = new RegExp(c7), dT = new RegExp("^" + dh + "$"), da = {
            ID: new RegExp("^#(" + dh + ")"),
            CLASS: new RegExp("^\\.(" + dh + ")"),
            TAG: new RegExp("^(" + dh + "|[*])"),
            ATTR: new RegExp("^" + dW),
        ...
        }, d2 = /HTML$/i, dE = /^(?:input|select|textarea|button)$/i, dk = /^h\d$/i, dm = /^[^{]+\{\s*\[native \w/, d5 = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, c4 = /[+~]/, dN = new RegExp("\\\\[\\da-fA-F]{1,6}" + ds + "?|\\\\([^\\r\\n\\f])","g"), dw = function(a, c) {
        ...
        try {
            dd.apply(dL = dy.call(dA.childNodes), dA.childNodes),
            dL[dA.childNodes.length].nodeType
        } catch (c2) {
            dd = {
        ...
        function dK(y, g, m, w) {
            ...
            if (m = m || [],
            "string" != typeof y || !y || 1 !== v && 9 !== v && 11 !== v) {
                return m
            }
            if (!w && (dM(g),
            g = g || cW,
            c3)) {
                if (11 !== v && (z = d5.exec(y))) {
                    if (j = z[1]) {
                        ...
                        if (z[2]) {
                            return dd.apply(m, g.getElementsByTagName(y)),
                            m
                        }
                        if ((j = z[3]) && cZ.getElementsByClassName && g.getElementsByClassName) {
                            return dd.apply(m, g.getElementsByClassName(j)),
                            m
                        }
                    }
                }
                if (cZ.qsa && !dv[y + " "] && (!dS || !dS.test(y)) && (1 !== v || "object" !== g.nodeName.toLowerCase())) {
                    if (d = y,
                    h = g,
                    1 === v && (dQ.test(y) || d4.test(y))) {
                        (h = c4.test(y) && d3(g.parentNode) || g) === g && cZ.scope || ((x = g.getAttribute("id")) ? x = x.replace(dH, di) : g.setAttribute("id", x = dJ)),
                        q = (k = dc(y)).length;
                        while (q--) {
                    ...
                    try {
                        return dd.apply(m, h.querySelectorAll(d)),
                        m
                    } catch (g) {
                        dv(y, !0)
                    } finally {
        ...
        function dR() {
            ...
            return function a(d, c) {
                return b.push(d + " ") > cS.cacheLength && delete a[b.shift()],
                a[d + " "] = c
            }
        }
        function dq(a) {
        ...
        for (c2 in cZ = dK.support = {},
        dg = dK.isXML = function(a) {
        ...
        dM = dK.setDocument = function(a) {
            ...
            return c != cW && 9 === c.nodeType && c.documentElement && (ct = (cW = c).documentElement,
            c3 = !dg(cW),
            dA != cW && (b = cW.defaultView) && b.top !== b && (b.addEventListener ? b.addEventListener("unload", dz, !1) : b.attachEvent && b.attachEvent("onunload", dz)),
            cZ.scope = cX(function(f) {
                return ct.appendChild(f).appendChild(cW.createElement("div")),
                "undefined" != typeof f.querySelectorAll && !f.querySelectorAll(":scope fieldset div").length
            }),
            cZ.attributes = cX(function(f) {
                return f.className = "i",
                !f.getAttribute("className")
            }),
            cZ.getElementsByTagName = cX(function(f) {
                return f.appendChild(cW.createComment("")),
                !f.getElementsByTagName("*").length
            }),
            cZ.getElementsByClassName = dm.test(cW.getElementsByClassName),
            cZ.getById = cX(function(f) {
                return ct.appendChild(f).id = dJ,
                !cW.getElementsByName || !cW.getElementsByName(dJ).length
            }),
            ...
            dI = [],
            dS = [],
            (cZ.qsa = dm.test(cW.querySelectorAll)) && (cX(function(f) {
                var g;
                ct.appendChild(f).innerHTML = "<a id='" + dJ + "'></a><select id='" + dJ + "-\r\\' msallowcapture=''><option selected=''></option></select>",
                f.querySelectorAll("[msallowcapture^='']").length && dS.push("[*^$]=" + ds + "*(?:''|\"\")"),
                f.querySelectorAll("[selected]").length || dS.push("\\[" + ds + "*(?:value|" + dG + ")"),
                f.querySelectorAll("[id~=" + dJ + "-]").length || dS.push("~="),
                (g = cW.createElement("input")).setAttribute("name", ""),
                f.appendChild(g),
                f.querySelectorAll("[name='']").length || dS.push("\\[" + ds + "*name" + ds + "*=" + ds + "*(?:''|\"\")"),
                f.querySelectorAll(":checked").length || dS.push(":checked"),
                f.querySelectorAll("a#" + dJ + "+*").length || dS.push(".#.+[+~]"),
            ...
            cX(function(f) {
                ...
                f.appendChild(g).setAttribute("name", "D"),
                f.querySelectorAll("[name=d]").length && dS.push("name" + ds + "*[*^$|!~]?="),
                2 !== f.querySelectorAll(":enabled").length && dS.push(":enabled", ":disabled"),
                ct.appendChild(f).disabled = !0,
                2 !== f.querySelectorAll(":disabled").length && dS.push(":enabled", ":disabled"),
            ...
            (cZ.matchesSelector = dm.test(cV = ct.matches || ct.webkitMatchesSelector || ct.mozMatchesSelector || ct.oMatchesSelector || ct.msMatchesSelector)) && cX(function(f) {
                cZ.disconnectedMatch = cV.call(f, "*"),
                cV.call(f, "[s!='']:x"),
                dI.push("!=", c7)
            }),
            dS = dS.length && new RegExp(dS.join("|")),
            dI = dI.length && new RegExp(dI.join("|")),
            d = dm.test(ct.compareDocumentPosition),
            d1 = d || dm.test(ct.contains) ? function(f, i) {
        ...
        dK.matchesSelector = function(a, c) {
            if (dM(a),
            cZ.matchesSelector && c3 && !dv[c + " "] && (!dI || !dI.test(c)) && (!dS || !dS.test(c))) {
                try {
                    var b = cV.call(a, c);
        ...
        dK.contains = function(a, b) {
            return (a.ownerDocument || a) != cW && dM(a),
            d1(a, b)
        }
        ,
        ...
        dK.uniqueSort = function(a) {
            var f, c = [], d = 0, b = 0;
            if (dn = !cZ.detectDuplicates,
            dP = !cZ.sortStable && a.slice(0),
            a.sort(c0),
            dn) {
                while (f = a[b++]) {
                    f === a[b] && (d = c.push(b))
        ...
        (cS = dK.selectors = {
            ...
            preFilter: {
                ATTR: function(a) {
                    return a[1] = a[1].replace(dN, dw),
                    a[3] = (a[3] || a[4] || a[5] || "").replace(dN, dw),
                    "~=" === a[2] && (a[3] = " " + a[3] + " "),
                    a.slice(0, 4)
                },
                CHILD: function(a) {
                    return a[1] = a[1].toLowerCase(),
                    "nth" === a[1].slice(0, 3) ? (a[3] || dK.error(a[0]),
                    a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * ("even" === a[3] || "odd" === a[3])),
                    a[5] = +(a[7] + a[8] || "odd" === a[3])) : a[3] && dK.error(a[0]),
                    a
                },
                PSEUDO: function(a) {
                    var c, b = !a[6] && a[2];
                    return da.CHILD.test(a[0]) ? null : (a[3] ? a[2] = a[4] || a[5] || "" : b && dZ.test(b) && (c = dc(b, !0)) && (c = b.indexOf(")", b.length - c) - b.length) && (a[0] = a[0].slice(0, c),
                    a[2] = b.slice(0, c)),
                    a.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(b, c, a) {
                    return function(d) {
                        var f = dK.attr(d, b);
                        return null == f ? "!=" === c : !c || (f += "",
                        "=" === c ? f === a : "!=" === c ? f !== a : "^=" === c ? a && 0 === f.indexOf(a) : "*=" === c ? a && -1 < f.indexOf(a) : "$=" === c ? a && f.slice(-a.length) === a : "~=" === c ? -1 < (" " + f.replace(cT, " ") + " ").indexOf(a) : "|=" === c && (f === a || f.slice(0, a.length + 1) === a + "-"))
                    }
                },
                CHILD: function(c, a, f, b, i) {
                    ...
                    : function(q, D, y) {
                        var B, w, z, g, C, E, x = k !== d ? "nextSibling" : "previousSibling", h = q.parentNode, v = j && q.nodeName.toLowerCase(), A = !y && !j, m = !1;
                        if (h) {
                            if (k) {
                                while (x) {
                                    g = q;
                            ...
                            if (E = [d ? h.firstChild : h.lastChild],
                            d && A) {
                                m = (C = (B = (w = (z = (g = h)[dJ] || (g[dJ] = {}))[g.uniqueID] || (z[g.uniqueID] = {}))[c] || [])[0] === dl && B[1]) && B[2],
                                g = C && h.childNodes[C];
                                ...
                                if (A && (m = C = (B = (w = (z = (g = q)[dJ] || (g[dJ] = {}))[g.uniqueID] || (z[g.uniqueID] = {}))[c] || [])[0] === dl && B[1]),
                                !1 === m) {
                                    while (g = ++C && g && g[x] || (m = C = 0) || E.pop()) {
                                        if ((j ? g.nodeName.toLowerCase() === v : 1 === g.nodeType) && ++m && (A && ((w = (z = g[dJ] || (g[dJ] = {}))[g.uniqueID] || (z[g.uniqueID] = {}))[c] = [dl, m]),
                                        g === q)) {
                                            break
                                        }
                                    }
                ...
                PSEUDO: function(c, d) {
                    ...
                    return b[dJ] ? b(d) : 1 < b.length ? (f = [c, c, "", d],
                    cS.setFilters.hasOwnProperty(c.toLowerCase()) ? dq(function(a, k) {
            ...
            pseudos: {
                ...
                contains: dq(function(a) {
                    return a = a.replace(dN, dw),
                    function(b) {
                        return -1 < (b.textContent || dx(b)).indexOf(a)
                    }
                }),
                lang: dq(function(a) {
                    return dT.test(a || "") || dK.error("unsupported lang: " + a),
                    a = a.replace(dN, dw).toLowerCase(),
                    function(b) {
                        var c;
                        do {
        ...
        function cU(i, b, j) {
            ...
            : function(f, s, m) {
                ...
                if (m) {
                    ...
                    while (f = f[k]) {
                        if (1 === f.nodeType || d) {
                            if (l = (p = f[dJ] || (f[dJ] = {}))[f.uniqueID] || (p[f.uniqueID] = {}),
                            g && g === f.nodeName.toLowerCase()) {
                                f = f[k] || f
                            } else {
        ...
        function cY(a, f, c, i, j, b) {
            ...
            dq(function(h, A, v, y) {
                var m, w, d, z = [], B = [], q = A.length, g = h || function(l, u, p) {
                    ...
                    return p
                }(f || "*", v.nodeType ? [v] : v, []), k = !a || !h && f ? g : dO(g, z, a, v, y), x = c ? j || (h ? a : q || i) ? [] : A : k;
                if (c && c(k, x, v, y),
                i) {
                    m = dO(x, B),
                    i(m, [], v, y),
                ...
                if (h) {
                    ...
                    x = dO(x === A ? x.splice(q, x.length) : x),
                    j ? j(null, A, x, y) : dd.apply(A, x)
                }
            })
        }
        function c5(f) {
            for (var g, q, j, m = f.length, k = cS.relative[f[0].type], b = k || cS.relative[" "], p = k ? 1 : 0, v = cU(function(a) {
                ...
                if (q = cS.relative[f[p].type]) {
                    ...
                    if ((q = cS.filter[f[p].type].apply(null, f[p].matches))[dJ]) {
                        ...
                        return cY(1 < p && dX(d), 1 < p && d0(f.slice(0, p - 1).concat({
                            value: " " === f[p - 2].type ? "*" : ""
                        })).replace(at, "$1"), q, p < j && c5(f.slice(p, j)), j < m && c5(f = f.slice(j)), j < m && d0(f))
                    }
                    d.push(q)
                }
            }
        ...
        return dt.prototype = cS.filters = cS.pseudos,
        cS.setFilters = new dt,
        dc = dK.tokenize = function(c, m) {
            ...
            p = cS.preFilter;
            while (b) {
                for (h in g && !(j = bt.exec(b)) || (j && (b = b.slice(j[0].length) || b),
                k.push(d = [])),
                g = !1,
                (j = d4.exec(b)) && (g = j.shift(),
                d.push({
                    value: g,
                    type: j[0].replace(at, " ")
                }),
                b = b.slice(g.length)),
                cS.filter) {
                    !(j = da[h].exec(b)) || p[h] && !(j = p[h](j)) || (g = j.shift(),
                    d.push({
                        value: g,
                        type: h,
                        matches: j
        ...
        c6 = dK.compile = function(c, k) {
            ...
            if (!b) {
                ...
                f = 0 < (q = d).length,
                p = 0 < l.length,
                j = function(x, I, D, G, B) {
                    var E, m, H, J = 0, C = "0", v = x && [], y = [], F = dV, w = x || p && cS.find.TAG("*", B), A = dl += null == F ? 1 : Math.random() || 0.1, z = w.length;
                    for (B && (dV = I == cW || I || B); C !== z && null != (E = w[C]); C++) {
                        if (p && E) {
                            m = 0,
                            I || E.ownerDocument == cW || (dM(E),
                            D = !c3);
                            while (H = l[m++]) {
                                if (H(E, I || cW, D)) {
                                    G.push(E);
                    ...
                    f && C !== J) {
                        ...
                        dd.apply(G, y),
                        B && !x && 0 < y.length && 1 < J + q.length && dK.uniqueSort(G)
                    }
                    return B && (dl = A,
                    dV = F),
                    v
        ...
        c9 = dK.select = function(f, q, j, m) {
            ...
            1 === d.length) {
                if (2 < (k = d[0] = d[0].slice(0)).length && "ID" === (b = k[0]).type && 9 === q.nodeType && c3 && cS.relative[k[1].type]) {
                    ...
                    h && (q = q.parentNode),
                    f = f.slice(k.shift().value.length)
                }
                g = da.needsContext.test(f) ? 0 : k.length;
                while (g--) {
                    if (b = k[g],
                    cS.relative[p = b.type]) {
                        break
                    }
            ...
            return (h || c6(f, d))(m, q, !c3, j, !q || c4.test(f) && d3(q.parentNode) || q),
            j
        }
        ,
        cZ.sortStable = dJ.split("").sort(c0).join("") === dJ,
        cZ.detectDuplicates = !!dn,
        dM(),
        cZ.sortDetached = cX(function(a) {
    ...
    b4.find = aB,
    b4.expr = aB.selectors,
    b4.expr[":"] = b4.expr.pseudos,
    b4.uniqueSort = b4.unique = aB.uniqueSort,
    b4.text = aB.getText,
    b4.isXMLDoc = aB.isXML,
    b4.contains = aB.contains,
    b4.escapeSelector = aB.escape;
    ...
    b4.filter = function(a, d, b) {
        var c = d[0];
        return b && (a = ":not(" + a + ")"),
        1 === d.length && 1 === c.nodeType ? b4.find.matchesSelector(c, a) ? [c] : [] : b4.find.matches(a, b4.grep(d, function(f) {
            return 1 === f.nodeType
        }))
    }
    ,
    ...
    (b4.fn.init = function(a, f, c) {
        ...
        "string" == typeof a) {
            ...
            if (d[1]) {
                if (f = f instanceof b4 ? f[0] : f,
                b4.merge(this, b4.parseHTML(d[1], f && f.nodeType ? f.ownerDocument || f : aI, !0)),
                bA.test(d[1]) && b4.isPlainObject(f)) {
                    for (d in f) {
            ...
            return (b = aI.getElementById(d[2])) && (this[0] = b,
            this.length = 1),
            this
        }
        return a.nodeType ? (this[0] = a,
        this.length = 1,
        this) : bs(a) ? void 0 !== c.ready ? c.ready(a) : a(b4) : b4.makeArray(a, this)
    }
    ).prototype = b4.fn,
    bb = b4(aI);
    ...
    b4.each({
        ...
        contents: function(a) {
            return null != a.contentDocument && bX(a.contentDocument) ? a.contentDocument : (ai(a, "template") && (a = a.content || a),
            b4.merge([], a.childNodes))
        }
    }, function(b, a) {
        b4.fn[b] = function(c, f) {
            var d = b4.map(this, a, c);
            return "Until" !== b.slice(-5) && (f = c),
            f && "string" == typeof f && (d = b4.filter(f, d)),
            1 < this.length && (a0[b] || b4.uniqueSort(d),
            bn.test(b) && d.reverse()),
            this.pushStack(d)
        }
    });
    ...
    b4.Callbacks = function(q) {
        var g, m;
        q = "string" == typeof q ? (g = q,
        m = {},
        b4.each(g.match(bM) || [], function(a, c) {
            m[c] = !0
        }),
        m) : b4.extend({}, q);
        var j, w, p, b, v = [], x = [], k = -1, d = function() {
            ...
            p = j = !0; x.length; k = -1) {
                w = x.shift();
                while (++k < v.length) {
                    !1 === v[k].apply(w[0], w[1]) && q.stopOnFalse && (k = v.length,
                    w = !1)
                }
            }
            q.memory || (w = !1),
            ...
            fireWith: function(a, c) {
                return b || (c = [a, (c = c || []).slice ? c.slice() : c],
                x.push(c),
                j || d()),
                this
            },
    ...
    b4.extend({
        Deferred: function(c) {
                ...
                then: function(i, e, h) {
                    ...
                    function a(l, m, k, n) {
                        return function() {
                            var p = this
                              ...
                              , o = function() {
                                ...
                                if (!(l < j)) {
                                    ...
                                    bs(u) ? n ? u.call(r, a(j, m, bY, n), a(j, m, bu, n)) : (j++,
                                    u.call(r, a(j, m, bY, n), a(j, m, bu, n), a(j, m, bY, m.notifyWith))) : (k !== bY && (p = void 0,
                                    q = [r]),
                                    (n || m.resolveWith)(p, q))
                                }
                            }
                              , s = n ? o : function() {
                                try {
                                    ...
                                    b4.Deferred.exceptionHook && b4.Deferred.exceptionHook(r, s.stackTrace),
                                    j <= l + 1 && (k !== bu && (p = void 0,
                                    q = [r]),
                                    m.rejectWith(p, q))
                                }
                            ...
                            ;
                            l ? s() : (b4.Deferred.getStackHook && (s.stackTrace = b4.Deferred.getStackHook()),
                            aw.setTimeout(s))
                        }
                    }
                    return b4.Deferred(function(k) {
                        f[0][3].add(a(0, k, bs(h) ? h : bY, k.notifyWith)),
                        f[1][3].add(a(0, k, bs(i) ? i : bY)),
                        f[2][3].add(a(0, k, bs(e) ? e : bu))
                    }).promise()
                },
                promise: function(a) {
            ...
            return b4.each(f, function(a, j) {
                ...
                i && h.add(function() {
                    d = i
                }, f[3 - a][2].disable, f[3 - a][3].disable, f[0][2].lock, f[0][3].lock),
                h.add(j[3].fire),
                g[j[0]] = function() {
                    return g[j[0] + "With"](this === g ? void 0 : this, arguments),
                    this
                }
                ,
        ...
        when: function(c) {
            var f = arguments.length
              ...
              , b = function(a) {
                return function(i) {
                    h[a] = this,
                    d[a] = 1 < arguments.length ? b3.call(arguments) : i,
                    --f || g.resolveWith(h, d)
                }
            };
            if (f <= 1 && (a6(c, g.done(b(j)).resolve, g.reject, !f),
            "pending" === g.state() || bs(d[j] && d[j].then))) {
                return g.then()
            }
            while (j--) {
                a6(d[j], b(j), g.reject)
    ...
    var aO = b4.Deferred();
    function ao() {
        aI.removeEventListener("DOMContentLoaded", ao),
        aw.removeEventListener("load", ao),
        b4.ready()
    }
    ...
    b4.ready.then = aO.then,
    "complete" === aI.readyState || "loading" !== aI.readyState && !aI.documentElement.doScroll ? aw.setTimeout(b4.ready) : (aI.addEventListener("DOMContentLoaded", ao),
    aw.addEventListener("load", ao));
    ...
    aU.prototype = {
        cache: function(a) {
            ...
            return b || (b = {},
            cn(a) && (a.nodeType ? a[this.expando] = b : Object.defineProperty(a, this.expando, {
                value: b,
                configurable: !0
            }))),
            b
    ...
    function cM(a, f, c) {
        ...
        if (void 0 === c && 1 === a.nodeType) {
            if (d = "data-" + f.replace(bi, "-$&").toLowerCase(),
    ...
    b4.fn.extend({
        data: function(f, c) {
            ...
            if (void 0 === f) {
                if (this.length && (d = bS.get(g),
                1 === g.nodeType && !cG.get(g, "hasDataAttrs"))) {
                    j = b.length;
                    while (j--) {
                        b[j] && 0 === (h = b[j].name).indexOf("data-") && (h = cA(h.slice(5)),
                        cM(g, h, d[h]))
                    }
    ...
    b4.extend({
        queue: function(a, d, b) {
            ...
            if (a) {
                return d = (d || "fx") + "queue",
                c = cG.get(a, d),
                b && (!c || Array.isArray(b) ? c = cG.access(a, d, b4.makeArray(b)) : c.push(b)),
                c || []
            }
        },
        dequeue: function(a, g) {
            ...
            var c = b4.queue(a, g)
              , f = c.length
              , b = c.shift()
              , d = b4._queueHooks(a, g);
            "inprogress" === b && (b = c.shift(),
            f--),
            b && ("fx" === g && c.unshift("inprogress"),
            delete d.stop,
            b.call(a, function() {
                b4.dequeue(a, g)
            }, d)),
    ...
    b4.fn.extend({
        queue: function(c, b) {
            ...
            c = "fx",
            a--),
            arguments.length < a ? b4.queue(this[0], c) : void 0 === b ? this : this.each(function() {
                var d = b4.queue(this, c, b);
                b4._queueHooks(this, c),
                "fx" === c && "inprogress" !== d[0] && b4.dequeue(this, c)
            })
        },
        dequeue: function(a) {
            return this.each(function() {
        ...
        promise: function(c, k) {
            ...
            c = c || "fx";
            while (b--) {
                (f = cG.get(g[b], c + "queueHooks")) && f.empty && (h++,
                f.empty.add(j))
            }
            return j(),
            d.promise(k)
    ...
    var aJ = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
      , cb = new RegExp("^(?:([+-])=|)(" + aJ + ")([a-z%]*)$","i")
      , bB = ["Top", "Right", "Bottom", "Left"]
      , bZ = aI.documentElement
      , a7 = function(a) {
    ...
    function b5(f, q, j, m) {
        ...
        , v = p(), h = j && j[3] || (b4.cssNumber[q] ? "" : "px"), d = f.nodeType && (b4.cssNumber[q] || "px" !== h && +v) && cb.exec(b4.css(f, q));
        if (d && d[3] !== h) {
            v /= 2,
            h = h || d[3],
            d = +v || 1;
    ...
    function bo(g, w) {
        for (var m, q, j, p, b, v, x, k = [], d = 0, h = g.length; d < h; d++) {
            (q = g[d]).style && (m = q.style.display,
            w ? ("none" === m && (k[d] = cG.get(q, "display") || null,
            k[d] || (q.style.display = "")),
            "" === q.style.display && aj(q) && (k[d] = (x = b = p = void 0,
            b = (j = q).ownerDocument,
            v = j.nodeName,
            (x = ci[v]) || (p = b.body.appendChild(b.createElement(v)),
            x = b4.css(p, "display"),
            p.parentNode.removeChild(p),
            "none" === x && (x = "block"),
            ci[v] = x)))) : "none" !== m && (k[d] = "none",
            cG.set(q, "display", m)))
        }
        for (d = 0; d < h; d++) {
    ...
    var ax, aP, bN = /^(?:checkbox|radio)$/i, aD = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, a1 = /^$|^module$|\/(?:java|ecma)script/i;
    ax = aI.createDocumentFragment().appendChild(aI.createElement("div")),
    (aP = aI.createElement("input")).setAttribute("type", "radio"),
    aP.setAttribute("checked", "checked"),
    aP.setAttribute("name", "t"),
    ax.appendChild(aP),
    cF.checkClone = ax.cloneNode(!0).cloneNode(!0).lastChild.checked,
    ax.innerHTML = "<textarea>x</textarea>",
    cF.noCloneChecked = !!ax.cloneNode(!0).lastChild.defaultValue,
    ax.innerHTML = "<option></option>",
    cF.option = !!ax.lastChild;
    var aV = {
        thead: [1, "<table>", "</table>"],
    ...
    function co(a, c) {
        ...
        void 0 === c || c && ai(a, c) ? b4.merge([a], b) : b
    }
    function cH(a, d) {
        for (var b = 0, c = a.length; b < c; b++) {
    ...
    aV.th = aV.td,
    cF.option || (aV.optgroup = aV.option = [1, "<select multiple='multiple'>", "</select>"]);
    var bv = /<|&#?\w+;/;
            ...
            if ((y = k[j]) || 0 === y) {
                if ("object" === cs(y)) {
                    ...
                    if (bv.test(y)) {
                        ...
                        D = aV[B] || aV._default,
                        b.innerHTML = D[1] + b4.htmlPrefilter(y) + D[2],
                        g = D[0];
                        while (g--) {
                            b = b.lastChild
                        }
                        b4.merge(z, b.childNodes),
    ...
    var ap = /^key/
      , cv = /^(?:mouse|pointer|contextmenu|drag|drop)|click/
      , cc = /^([^.]*)(?:\.(.+)|)/;
    function ay() {
        return !0
    }
    ...
    function bj(c, k, f, h, d, g) {
        var b, j;
        if ("object" == typeof k) {
            for (j in "string" != typeof f && (h = h || f,
            f = void 0),
            k) {
                bj(c, j, f, h, k[j], g)
            }
            ...
            handler: function(d) {
                ...
                if (1 & d.isTrigger && this[b]) {
                    if (g.length) {
                        ...
                        if (g = b3.call(arguments),
                        cG.set(this, b, g),
                        h = c(this, b),
                        this[b](),
                        g !== (f = cG.get(this, b)) || h ? cG.set(this, b, !1) : f = {},
                        g !== f) {
                    ...
                    g.length && (cG.set(this, b, {
                        value: b4.event.trigger(b4.extend(g[0], b4.Event.prototype), g.slice(1), this)
                    }),
    ...
    b4.event = {
        global: {},
        add: function(F, m, A, D, y) {
            var B, b, E, G, z, j, q, C, k, x, w, H = cG.get(F);
            if (cn(F)) {
                A.handler && (A = (B = A).handler,
                y = B.selector),
                y && b4.find.matchesSelector(bZ, y),
                A.guid || (A.guid = b4.guid++),
                (G = H.events) || (G = H.events = Object.create(null)),
                ...
                while (z--) {
                    k = w = (E = cc.exec(m[z]) || [])[1],
                    x = (E[2] || "").split(".").sort(),
                    k && (q = b4.event.special[k] || {},
                    k = (y ? q.delegateType : q.bindType) || k,
                    q = b4.event.special[k] || {},
                    j = b4.extend({
                        type: k,
                        origType: w,
                        data: D,
                    ...
                    q.setup && !1 !== q.setup.call(F, D, x, b) || F.addEventListener && F.addEventListener(k, b)),
                    q.add && (q.add.call(F, j),
                    j.handler.guid || (j.handler.guid = A.guid)),
                    y ? C.splice(C.delegateCount++, 0, j) : C.push(j),
                    b4.event.global[k] = !0)
                }
            }
        },
        remove: function(m, F, A, D, y) {
            ...
            if (H && (G = H.events)) {
                ...
                while (z--) {
                    if (k = w = (E = cc.exec(F[z]) || [])[1],
                    x = (E[2] || "").split(".").sort(),
                    k) {
                        q = b4.event.special[k] || {},
                        C = G[k = (D ? q.delegateType : q.bindType) || k] || [],
                        E = E[2] && new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        b = B = C.length;
                        while (B--) {
                            j = C[B],
                            !y && w !== j.origType || A && A.guid !== j.guid || E && !E.test(j.namespace) || D && D !== j.selector && ("**" !== D || !j.selector) || (C.splice(B, 1),
                            j.selector && C.delegateCount--,
                            q.remove && q.remove.call(m, j))
                        }
                        b && !C.length && (q.teardown && !1 !== q.teardown.call(m, x, H.handle) || b4.removeEvent(m, k, H.handle),
                        delete G[k])
                    } else {
                        for (k in G) {
        ...
        dispatch: function(f) {
            var q, j, m, g, k, b, p = new Array(arguments.length), v = b4.event.fix(f), h = (cG.get(this, "events") || Object.create(null))[v.type] || [], d = b4.event.special[v.type] || {};
            for (p[0] = v,
            q = 1; q < arguments.length; q++) {
                p[q] = arguments[q]
            }
            if (v.delegateTarget = this,
            !d.preDispatch || !1 !== d.preDispatch.call(this, v)) {
                b = b4.event.handlers.call(this, v, h),
                q = 0;
                while ((g = b[q++]) && !v.isPropagationStopped()) {
                    v.currentTarget = g.elem,
                    j = 0;
                    while ((k = g.handlers[j++]) && !v.isImmediatePropagationStopped()) {
                        v.rnamespace && !1 !== k.namespace && !v.rnamespace.test(k.namespace) || (v.handleObj = k,
                        v.data = k.data,
                        void 0 !== (m = ((b4.event.special[k.origType] || {}).handle || k.handler).apply(g.elem, p)) && !1 === (v.result = m) && (v.preventDefault(),
                        v.stopPropagation()))
                    }
                }
                return d.postDispatch && d.postDispatch.call(this, v),
                v.result
            }
        },
            ...
            if (p && f.nodeType && !("click" === c.type && 1 <= c.button)) {
                for (; f !== this; f = f.parentNode || this) {
                    if (1 === f.nodeType && ("click" !== c.type || !0 !== f.disabled)) {
                        ...
                        b = {},
                        g = 0; g < p; g++) {
                            void 0 === b[d = (j = m[g]).selector + " "] && (b[d] = j.needsContext ? -1 < b4(d, this).index(f) : b4.find(d, this, null, [f]).length),
                            b[d] && h.push(j)
                        }
                        h.length && k.push({
                            elem: f,
        ...
        special: {
            ...
            click: {
                setup: function(a) {
                    var b = this || a;
                    return bN.test(b.type) && b.click && ai(b, "input") && ak(b, "click", ay),
                    !1
                },
                trigger: function(a) {
                    var b = this || a;
                    return bN.test(b.type) && b.click && ai(b, "input") && ak(b, "click"),
                    !0
                },
                _default: function(a) {
                    var b = a.target;
    ...
    b4.Event = function(a, b) {
        ...
        this.type = a.type,
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? ay : aK,
    ...
    b4.each({
        ...
        b4.event.special[a] = {
            ...
            handle: function(c) {
                ...
                return d && (d === this || b4.contains(this, d)) || (c.type = f.origType,
    ...
    b4.fn.extend({
        ...
        off: function(a, f, c) {
            ...
            if (a && a.preventDefault && a.handleObj) {
                ...
                b4(a.delegateTarget).off(d.namespace ? d.origType + "." + d.namespace : d.origType, d.selector, d.handler),
                this
            }
            if ("object" == typeof a) {
                for (b in a) {
    ...
    function bI(c, k) {
        ...
        if (1 === k.nodeType) {
            if (cG.hasData(c) && (j = cG.get(c).events)) {
                for (d in cG.remove(k, "handle events"),
                j) {
                    for (f = 0,
                    h = j[d].length; f < h; f++) {
    ...
    function bO(x, A, v, y) {
        ...
        if (q || 1 < m && "string" == typeof j && !cF.checkClone && aE.test(j)) {
            return x.each(function(a) {
                var c = x.eq(a);
                q && (A[0] = j.call(this, a, c.html())),
                bO(c, A, v, y)
            })
        }
        if (m && (C = (k = cB(A, x[0].ownerDocument, !1, x, y)).firstChild,
        1 === k.childNodes.length && (k = C),
        C || y)) {
            for (B = (b = b4.map(co(k, "script"), bp)).length; g < m; g++) {
                D = k,
                g !== z && (D = b4.clone(D, !0, !0),
                B && b4.merge(b, co(D, "script"))),
                v.call(x[g], D, g)
            }
            if (B) {
                for (w = b[b.length - 1].ownerDocument,
                b4.map(b, a2),
                g = 0; g < B; g++) {
                    D = b[g],
                    a1.test(D.type || "") && !cG.access(D, "globalEval") && b4.contains(w, D) && (D.src && "module" !== (D.type || "").toLowerCase() ? b4._evalUrl && !D.noModule && b4._evalUrl(D.src, {
                        nonce: D.nonce || D.getAttribute("nonce")
                    }, w) : an(D.textContent.replace(bd, ""), D, w))
                }
            }
        }
        return x
    ...
    function b0(a, g, c) {
        for (var f, b = g ? b4.filter(g, a) : a, d = 0; null != (f = b[d]); d++) {
            c || 1 !== f.nodeType || b4.cleanData(co(f)),
            f.parentNode && (c && a7(f) && cH(co(f, "script")),
    ...
    b4.extend({
        ...
        clone: function(g, w, m) {
            ...
            if (!(cF.noCloneChecked || 1 !== g.nodeType && 11 !== g.nodeType || b4.isXMLDoc(g))) {
                for (b = co(d),
                q = 0,
                j = (p = co(g)).length; q < j; q++) {
                    v = p[q],
                    x = b[q],
                    void 0,
                    "input" === (k = x.nodeName.toLowerCase()) && bN.test(v.type) ? x.checked = v.checked : "input" !== k && "textarea" !== k || (x.defaultValue = v.defaultValue)
                }
            }
            if (w) {
                if (m) {
            ...
            return 0 < (b = co(d, "script")).length && cH(b, !h && co(g, "script")),
            d
        },
    ...
    b4.fn.extend({
        ...
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) {
                1 === a.nodeType && (b4.cleanData(co(a, !1)),
                a.textContent = "")
            }
            return this
        },
        ...
        html: function(a) {
            return aa(this, function(b) {
                ...
                if ("string" == typeof b && !bC.test(b) && !aV[(aD.exec(b) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; c < d; c++) {
                            1 === (f = this[c] || {}).nodeType && (b4.cleanData(co(f, !1)),
                            f.innerHTML = b)
                        }
                        f = 0
                    } catch (b) {}
        ...
        replaceWith: function() {
            ...
            return bO(this, arguments, function(b) {
                ...
                b4.inArray(this, a) < 0 && (b4.cleanData(co(this)),
    ...
    var bw = new RegExp("^(" + aJ + ")(?!px)[a-z%]+$","i")
      , a8 = function(a) {
        var b = a.ownerDocument.defaultView;
        return b && b.opener || (b = aw),
    ...
    function aq(c, k, f) {
        ...
        return (f = f || a8(c)) && ("" !== (b = f.getPropertyValue(k) || f[k]) || a7(c) || (b = b4.style(c, k)),
        !cF.pixelBoxStyles() && bw.test(b) && aQ.test(k) && (h = j.width,
        d = j.minWidth,
        g = j.maxWidth,
    ...
    !function() {
        function c() {
            if (f) {
                ...
                bZ.appendChild(p).appendChild(f);
        ...
        cF.clearCloneStyle = "content-box" === f.style.backgroundClip,
        b4.extend(cF, {
            ...
            reliableTrDimensions: function() {
                var a, o, i, l;
                return null == b && (a = aI.createElement("table"),
                o = aI.createElement("tr"),
                i = aI.createElement("div"),
                a.style.cssText = "position:absolute;left:-11111px",
                o.style.height = "1px",
                i.style.height = "9px",
                bZ.appendChild(a).appendChild(o).appendChild(i),
                l = aw.getComputedStyle(o),
                b = 3 < parseInt(l.height),
                bZ.removeChild(a)),
                b
            }
        }))
    ...
    function bk(c, k, f, h, d, g) {
        ...
        for (; b < 4; b += 2) {
            "margin" === f && (l += b4.css(c, f + bB[b], !0, d)),
            h ? ("content" === f && (l -= b4.css(c, "padding" + bB[b], !0, d)),
            "margin" !== f && (l -= b4.css(c, "border" + bB[b] + "Width", !0, d))) : (l += b4.css(c, "padding" + bB[b], !0, d),
            "padding" !== f ? l += b4.css(c, "border" + bB[b] + "Width", !0, d) : j += b4.css(c, "border" + bB[b] + "Width", !0, d))
        }
        return !h && 0 <= g && (l += Math.max(0, Math.ceil(c["offset" + k[0].toUpperCase() + k.slice(1)] - g - l - j - 0.5)) || 0),
        l
    }
    function cO(c, k, f) {
        var h = a8(c)
          , d = (!cF.boxSizingReliable() || f) && "border-box" === b4.css(c, "boxSizing", !1, h)
          , g = d
          , b = aq(c, k, h)
        ...
        return (!cF.boxSizingReliable() && d || !cF.reliableTrDimensions() && ai(c, "tr") || "auto" === b || !parseFloat(b) && "inline" === b4.css(c, "display", !1, h)) && c.getClientRects().length && (d = "border-box" === b4.css(c, "boxSizing", !1, h),
        (g = j in c) && (b = c[j])),
        (b = parseFloat(b) || 0) + bk(c, k, f || (d ? "border" : "content"), g, h, b) + "px"
    }
    ...
    b4.extend({
        ...
        style: function(c, m, g, j) {
            if (c && 3 !== c.nodeType && 8 !== c.nodeType && c.style) {
                ...
                if (p || (m = cC(k)),
                b = b4.cssHooks[m] || b4.cssHooks[k],
                void 0 === g) {
                    return b && "get"in b && void 0 !== (d = b.get(c, !1, j)) ? d : f[m]
                }
                "string" === (h = typeof g) && (d = cb.exec(g)) && d[1] && (g = b5(c, m, d),
                h = "number"),
                null != g && g == g && ("number" !== h || p || (g += d && d[3] || (b4.cssNumber[k] ? "" : "px")),
                cF.clearCloneStyle || "" !== g || 0 !== m.indexOf("background") || (f[m] = "inherit"),
                b && "set"in b && void 0 === (g = b.set(c, g, j)) || (p ? f.setProperty(m, g) : f[m] = g))
            }
        },
        css: function(c, k, f, h) {
            var d, g, b, j = cA(k);
            return aW.test(k) || (k = cC(j)),
            (b = b4.cssHooks[k] || b4.cssHooks[j]) && "get"in b && (d = b.get(c, !0, f)),
            void 0 === d && (d = aq(c, k, h)),
            "normal" === d && k in bU && (d = bU[k]),
            "" === f || f ? (g = parseFloat(d),
    ...
    b4.each(["height", "width"], function(a, b) {
        b4.cssHooks[b] = {
            ...
            set: function(d, l, g) {
                var j, f = a8(d), h = !cF.scrollboxSize() && "absolute" === f.position, c = (h || g) && "border-box" === b4.css(d, "boxSizing", !1, f), k = g ? bk(d, b, g, c, f) : 0;
                return c && h && (k -= Math.ceil(d["offset" + b[0].toUpperCase() + b.slice(1)] - parseFloat(f[b]) - bk(d, b, "border", !1, f) - 0.5)),
                k && (j = cb.exec(l)) && "px" !== (j[3] || "px") && (d.style[b] = l,
                l = b4.css(d, b)),
                bf(0, l, k)
            }
        }
    ...
    b4.cssHooks.marginLeft = ab(cF.reliableMarginLeft, function(a, b) {
        if (b) {
            return (parseFloat(aq(a, "marginLeft")) || a.getBoundingClientRect().left - cw(a, {
                marginLeft: 0
            }, function() {
    ...
    ((b4.Tween = aL).prototype = {
        ...
        init: function(a, g, c, f, b, d) {
            this.elem = a,
            this.prop = c,
            this.easing = b || b4.easing._default,
            this.options = g,
            this.start = this.now = this.cur(),
            this.end = f,
            this.unit = d || (b4.cssNumber[c] ? "" : "px")
        },
        cur: function() {
        ...
        run: function(a) {
            ...
            return this.options.duration ? this.pos = c = b4.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : this.pos = c = a,
            this.now = (this.end - this.start) * c + this.start,
            this.options.step && this.options.step.call(this.elem, this.now, this),
            b && b.set ? b.set(this) : aL.propHooks._default.set(this),
            this
        }
    }).init.prototype = aL.prototype,
    (aL.propHooks = {
        _default: {
            get: function(a) {
                var b;
    ...
    b4.fx = aL.prototype.init,
    b4.fx.step = {};
    var cd, bD, b1, a9, bJ = /^(?:toggle|show|hide)$/, al = /queueHooks$/;
    function b7() {
        bD && (!1 === aI.hidden && aw.requestAnimationFrame ? aw.requestAnimationFrame(b7) : aw.setTimeout(b7, b4.fx.interval),
        b4.fx.tick())
    }
    function ck() {
    ...
    function aR(k, f, q) {
        var j, b, m = 0, g = aR.prefilters.length, p = b4.Deferred().always(function() {
            ...
            return p.notifyWith(k, [h, l, s]),
            l < 1 && c ? s : (c || p.notifyWith(k, [h, 1, 0]),
            p.resolveWith(k, [h]),
            !1)
        }, h = p.promise({
            elem: k,
            ...
            stop: function(a) {
                ...
                return a ? (p.notifyWith(k, [h, 1, 0]),
                p.resolveWith(k, [h, a])) : p.rejectWith(k, [h, a]),
                this
            }
        }), d = h.props;
        for (!function(l, y) {
            ...
            for (u in l) {
                if (s = y[x = cA(u)],
                w = l[u],
                Array.isArray(w) && (s = w[1],
                w = l[u] = w[0]),
                u !== x && (l[x] = w,
                delete l[u]),
                (c = b4.cssHooks[x]) && "expand"in c) {
                    for (u in w = c.expand(w),
                    delete l[x],
                    w) {
                        u in l || (l[u] = w[u],
                        y[u] = s)
            ...
            if (j = aR.prefilters[m].call(h, k, d, h.opts)) {
                return bs(j.stop) && (b4._queueHooks(h.elem, h.opts.queue).stop = j.stop.bind(j)),
                j
            }
        }
        return b4.map(d, az, h),
        bs(h.opts.start) && h.opts.start.call(k, h),
        h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always),
        b4.fx.timer(b4.extend(v, {
            elem: k,
            anim: h,
            queue: h.opts.queue
        })),
    ...
    b4.Animation = b4.extend(aR, {
        tweeners: {
            "*": [function(a, c) {
                ...
                return b5(b.elem, a, cb.exec(c), b),
                b
            }
            ]
        },
        tweener: function(a, f) {
            ...
            for (var c, d = 0, b = a.length; d < b; d++) {
                c = a[d],
                aR.tweeners[c] = aR.tweeners[c] || [],
                aR.tweeners[c].unshift(f)
            }
        },
        prefilters: [function(m, F, A) {
            var D, y, B, b, E, G, z, j, q = "width"in F || "height"in F, C = this, k = {}, x = m.style, w = m.nodeType && aj(m), H = cG.get(m, "fxshow");
            for (D in A.queue || (null == (b = b4._queueHooks(m, "fx")).unqueued && (b.unqueued = 0,
            E = b.empty.fire,
            ...
            C.always(function() {
                C.always(function() {
                    b.unqueued--,
                    b4.queue(m, "fx").length || b.empty.fire()
                })
            })),
            F) {
                if (y = F[D],
            ...
            if ((G = !b4.isEmptyObject(F)) || !b4.isEmptyObject(k)) {
                for (D in q && 1 === m.nodeType && (A.overflow = [x.overflow, x.overflowX, x.overflowY],
                null == (z = H && H.display) && (z = cG.get(m, "display")),
                "none" === (j = b4.css(m, "display")) && (z ? j = z : (bo([m], !0),
                z = m.style.display || z,
                j = b4.css(m, "display"),
                bo([m]))),
                ("inline" === j || "inline-block" === j && null != z) && "none" === b4.css(m, "float") && (G || (C.done(function() {
                    x.display = z
                }),
                null == z && (j = x.display,
                z = "none" === j ? "" : j)),
                x.display = "inline-block")),
                A.overflow && (x.overflow = "hidden",
                C.always(function() {
                    x.overflow = A.overflow[0],
                    x.overflowX = A.overflow[1],
                    x.overflowY = A.overflow[2]
                })),
                G = !1,
                k) {
                    G || (H ? "hidden"in H && (w = H.hidden) : H = cG.access(m, "fxshow", {
                        display: z
                    }),
                    B && (H.hidden = !w),
                    w && bo([m], !0),
    ...
    b4.speed = function(a, d, b) {
        ...
        return b4.fx.off ? c.duration = 0 : "number" != typeof c.duration && (c.duration in b4.fx.speeds ? c.duration = b4.fx.speeds[c.duration] : c.duration = b4.fx.speeds._default),
        null != c.queue && !0 !== c.queue || (c.queue = "fx"),
        c.old = c.complete,
        c.complete = function() {
            bs(c.old) && c.old.call(this),
            c.queue && b4.dequeue(this, c.queue)
        }
        ,
        c
    }
    ...
    b4.fn.extend({
        ...
        stop: function(d, c, f) {
            ...
            this.each(function() {
                ...
                for (i = g.length; i--; ) {
                    g[i].elem !== this || null != d && g[i].queue !== d || (g[i].anim.stop(f),
                    a = !1,
                    g.splice(i, 1))
                }
        ...
        finish: function(b) {
            return !1 !== b && (b = b || "fx"),
            this.each(function() {
                var a, h = cG.get(this), d = h[b + "queue"], g = h[b + "queueHooks"], c = b4.timers, f = d ? d.length : 0;
                for (h.finish = !0,
                b4.queue(this, b, []),
                g && g.stop && g.stop.call(this, !0),
                a = c.length; a--; ) {
                    c[a].elem === this && c[a].queue === b && (c[a].anim.stop(!0),
                    c.splice(a, 1))
                }
                for (a = 0; a < f; a++) {
    ...
    b4.fn.delay = function(b, a) {
        return b = b4.fx && b4.fx.speeds[b] || b,
        a = a || "fx",
        this.queue(a, function(c, f) {
    ...
    ,
    b1 = aI.createElement("input"),
    a9 = aI.createElement("select").appendChild(aI.createElement("option")),
    b1.type = "checkbox",
    cF.checkOn = "" !== b1.value,
    cF.optSelected = a9.selected,
    (b1 = aI.createElement("input")).value = "t",
    b1.type = "radio",
    cF.radioValue = "t" === b1.value;
    ...
    b4.extend({
        attr: function(a, g, c) {
            ...
            if (3 !== d && 8 !== d && 2 !== d) {
                return "undefined" == typeof a.getAttribute ? b4.prop(a, g, c) : (1 === d && b4.isXMLDoc(a) || (b = b4.attrHooks[g.toLowerCase()] || (b4.expr.match.bool.test(g) ? bP : void 0)),
                void 0 !== c ? null === c ? void b4.removeAttr(a, g) : b && "set"in b && void 0 !== (f = b.set(a, c, g)) ? f : (a.setAttribute(g, c + ""),
                c) : b && "get"in b && null !== (f = b.get(a, g)) ? f : null == (f = b4.find.attr(a, g)) ? void 0 : f)
            }
        },
        attrHooks: {
            type: {
    ...
    bP = {
        set: function(a, c, b) {
            return !1 === c ? b4.removeAttr(a, b) : a.setAttribute(b, b),
            b
        }
    },
    b4.each(b4.expr.match.bool.source.match(/\w+/g), function(c, d) {
        ...
        aF[d] = function(a, k, g) {
            ...
            return g || (f = aF[h],
            aF[h] = j,
            j = null != b(a, k, g) ? h : null,
            aF[h] = f),
            j
        }
    });
    var a3 = /^(?:input|select|textarea|button)$/i
      , aX = /^(?:a|area)$/i;
    function cq(a) {
    ...
    b4.extend({
        prop: function(a, g, c) {
            var f, b, d = a.nodeType;
            if (3 !== d && 8 !== d && 2 !== d) {
                return 1 === d && b4.isXMLDoc(a) || (g = b4.propFix[g] || g,
                b = b4.propHooks[g]),
        ...
        toggleClass: function(c, e) {
            ...
            return "boolean" == typeof e && b ? e ? this.addClass(c) : this.removeClass(c) : bs(c) ? this.each(function(a) {
                ...
                if (b) {
                    ...
                    void 0 !== c && "boolean" !== d || ((a = cJ(this)) && cG.set(this, "__className__", a),
                    this.setAttribute && this.setAttribute("class", a || !1 === c ? "" : cG.get(this, "__className__") || ""))
                }
            })
        },
        hasClass: function(a) {
    ...
    b4.fn.extend({
        val: function(c) {
            var d, a, b, f = this[0];
            return arguments.length ? (b = bs(c),
    ...
    b4.extend(b4.event, {
        trigger: function(k, C, x, A) {
            var v, y, b, B, D, w, g, m, z = [x || aI], j = cm.call(k, "type") ? k.type : k, q = cm.call(k, "namespace") ? k.namespace.split(".") : [];
            if (y = m = b = x = x || aI,
            3 !== x.nodeType && 8 !== x.nodeType && !ar.test(j + b4.event.triggered) && (-1 < j.indexOf(".") && (j = (q = j.split(".")).shift(),
            q.sort()),
            D = j.indexOf(":") < 0 && "on" + j,
            (k = k[b4.expando] ? k : new b4.Event(j,"object" == typeof k && k)).isTrigger = A ? 2 : 3,
            k.namespace = q.join("."),
            k.rnamespace = k.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null,
            k.result = void 0,
            k.target || (k.target = x),
            C = null == C ? [k] : b4.makeArray(C, [k]),
            g = b4.event.special[j] || {},
            A || !g.trigger || !1 !== g.trigger.apply(x, C))) {
                if (!A && !g.noBubble && !cz(x)) {
                    for (B = g.delegateType || j,
                    ar.test(B + j) || (y = y.parentNode); y; y = y.parentNode) {
                        z.push(y),
                        b = y
                    }
                ...
                while ((y = z[v++]) && !k.isPropagationStopped()) {
                    m = y,
                    k.type = 1 < v ? B : g.bindType || j,
                    (w = (cG.get(y, "events") || Object.create(null))[k.type] && cG.get(y, "handle")) && w.apply(y, C),
                    (w = D && y[D]) && w.apply && cn(y) && (k.result = w.apply(y, C),
                    !1 === k.result && k.preventDefault())
                }
                return k.type = j,
                A || k.isDefaultPrevented() || g._default && !1 !== g._default.apply(z.pop(), C) || !cn(x) || D && bs(x[j]) && !cz(x) && ((b = x[D]) && (x[D] = null),
                b4.event.triggered = j,
                k.isPropagationStopped() && m.addEventListener(j, cx),
                x[j](),
                k.isPropagationStopped() && m.removeEventListener(j, cx),
                b4.event.triggered = void 0,
                b && (x[D] = b)),
                k.result
            }
        },
        simulate: function(a, d, b) {
            var c = b4.extend(new b4.Event, b, {
                type: a,
                isSimulated: !0
            });
        ...
        b4.event.special[c] = {
            setup: function() {
                var d = this.ownerDocument || this.document || this
                  , f = cG.access(d, c);
                f || d.addEventListener(b, a, !0),
                cG.access(d, c, (f || 0) + 1)
            },
            teardown: function() {
                var d = this.ownerDocument || this.document || this
                  , f = cG.access(d, c) - 1;
                f ? cG.access(d, c, f) : (d.removeEventListener(b, a, !0),
                cG.remove(d, c))
            }
        }
    });
    ...
    b4.parseXML = function(a) {
        ...
        return b && !b.getElementsByTagName("parsererror").length || b4.error("Invalid XML: " + a),
        b
    }
    ;
    var b8 = /\[\]$/
    ...
    function aS(a) {
        return function(b, g) {
            ...
            if (bs(g)) {
                while (d = c[f++]) {
                    "+" === d[0] ? (d = d.slice(1) || "*",
                    (a[d] = a[d] || []).unshift(g)) : (a[d] = a[d] || []).push(g)
                }
            }
        }
    }
    function au(g, c, e, b) {
        ...
        function d(a) {
            var i;
            return f[a] = !0,
            b4.each(g[a] || [], function(j, l) {
                var k = l(c, e, b);
                return "string" != typeof k || h || f[k] ? h ? !(i = k) : void 0 : (c.dataTypes.unshift(k),
                d(k),
                !1)
            }),
            i
    ...
    b4.extend({
        ...
        ajax: function(A, M) {
            ...
            A = void 0),
            M = M || {};
            var q, B, J, H, z, K, D, C, E, I, P = b4.ajaxSetup({}, M), S = P.context || P, G = P.context && (S.nodeType || S.jquery) ? b4(S) : b4.event, R = b4.Deferred(), k = b4.Callbacks("once memory"), Q = P.statusCode || {}, j = {}, L = {}, O = "canceled", N = {
                readyState: 0,
                ...
                setRequestHeader: function(a, b) {
                    return null == D && (a = L[a.toLowerCase()] = L[a.toLowerCase()] || a,
                    j[a] = b),
                    this
                },
                overrideMimeType: function(a) {
                    return null == D && (P.mimeType = a),
                    this
                },
            ...
            if (R.promise(N),
            P.url = ((A || P.url || cf.href) + "").replace(bQ, cf.protocol + "//"),
            P.type = M.method || M.type || P.method || P.type,
            P.dataTypes = (P.dataType || "*").toLowerCase().match(bM) || [""],
            null == P.crossDomain) {
                K = aI.createElement("a");
                try {
                    K.href = P.url,
                    K.href = K.href,
                    P.crossDomain = cy.protocol + "//" + cy.host != K.protocol + "//" + K.host
                } catch (A) {
                    P.crossDomain = !0
                }
            }
            if (P.data && P.processData && "string" != typeof P.data && (P.data = b4.param(P.data, P.traditional)),
            au(b2, P, M, N),
            D) {
                return N
            }
            for (E in (C = b4.event && P.global) && 0 == b4.active++ && b4.event.trigger("ajaxStart"),
            P.type = P.type.toUpperCase(),
            P.hasContent = !bK.test(P.type),
            B = P.url.replace(bV, ""),
            P.hasContent ? P.data && P.processData && 0 === (P.contentType || "").indexOf("application/x-www-form-urlencoded") && (P.data = P.data.replace(bg, "+")) : (I = P.url.slice(B.length),
            P.data && (P.processData || "string" == typeof P.data) && (B += (aM.test(B) ? "&" : "?") + P.data,
            delete P.data),
            !1 === P.cache && (B = B.replace(br, "$1"),
            I = (aM.test(B) ? "&" : "?") + "_=" + aA.guid++ + I),
            P.url = B + I),
            P.ifModified && (b4.lastModified[B] && N.setRequestHeader("If-Modified-Since", b4.lastModified[B]),
            b4.etag[B] && N.setRequestHeader("If-None-Match", b4.etag[B])),
            (P.data && P.hasContent && !1 !== P.contentType || M.contentType) && N.setRequestHeader("Content-Type", P.contentType),
            N.setRequestHeader("Accept", P.dataTypes[0] && P.accepts[P.dataTypes[0]] ? P.accepts[P.dataTypes[0]] + ("*" !== P.dataTypes[0] ? ", " + ba + "; q=0.01" : "") : P.accepts["*"]),
            P.headers) {
            ...
            function F(c, v, g, m) {
                ...
                q = void 0,
                J = m || "",
                N.readyState = 0 < c ? 4 : 0,
                d = 200 <= c && c < 300 || 304 === c,
                g && (p = function(x, X, T) {
                    var V, y, U, l, W = x.contents, Y = x.dataTypes;
                    while ("*" === Y[0]) {
                        Y.shift(),
                        void 0 === V && (V = x.mimeType || X.getResponseHeader("Content-Type"))
                    }
                    if (V) {
                        for (y in W) {
                            if (W[y] && W[y].test(V)) {
                    ...
                    if (U) {
                        return U !== Y[0] && Y.unshift(U),
                        T[U]
                    }
                }(P, N, g)),
                !d && -1 < b4.inArray("script", P.dataTypes) && (P.converters["text script"] = function() {}
                ),
                p = function(T, ae, W, Y) {
                    ...
                    X = y.shift();
                    while (X) {
                        if (T.responseFields[X] && (W[T.responseFields[X]] = ae),
                        !at && Y && T.dataFilter && (ae = T.dataFilter(ae, T.dataType)),
                        at = X,
                        X = y.shift()) {
                            if ("*" === X) {
                                X = at
                ...
                d ? (P.ifModified && ((w = N.getResponseHeader("Last-Modified")) && (b4.lastModified[B] = w),
                (w = N.getResponseHeader("etag")) && (b4.etag[B] = w)),
                204 === c || "HEAD" === P.type ? f = "nocontent" : 304 === c ? f = "notmodified" : (f = p.state,
                h = p.data,
                d = !(b = p.error))) : (b = f,
                !c && f || (f = "error",
                c < 0 && (c = 0))),
                N.status = c,
                N.statusText = (v || f) + "",
                d ? R.resolveWith(S, [h, f, N]) : R.rejectWith(S, [N, f, b]),
                N.statusCode(Q),
                Q = void 0,
                C && G.trigger(d ? "ajaxSuccess" : "ajaxError", [N, P, d ? h : b]),
                k.fireWith(S, [N, f]),
                C && (G.trigger("ajaxComplete", [N, P]),
                --b4.active || b4.event.trigger("ajaxStop")))
            }
            return N
        },
    ...
    b4.fn.extend({
        wrapAll: function(a) {
            var b;
            return this[0] && (bs(a) && (a = a.call(this[0])),
            b = b4(a, this[0].ownerDocument).eq(0).clone(!0),
    ...
    var ag = {
      ...
      , cP = b4.ajaxSettings.xhr();
    cF.cors = !!cP && "withCredentials"in cP,
    cF.ajax = cP = !!cP,
    b4.ajaxTransport(function(c) {
        var d, b;
        if (cF.cors || cP && !c.crossDomain) {
            return {
                send: function(a, h) {
                    var f, g = c.xhr();
                    if (g.open(c.type, c.url, c.async, c.username, c.password),
                    c.xhrFields) {
                        for (f in c.xhrFields) {
                            g[f] = c.xhrFields[f]
                        }
                    }
                    for (f in c.mimeType && g.overrideMimeType && g.overrideMimeType(c.mimeType),
                    ...
                    d = function(i) {
                        return function() {
                            d && (d = b = g.onload = g.onerror = g.onabort = g.ontimeout = g.onreadystatechange = null,
                            "abort" === i ? g.abort() : "error" === i ? "number" != typeof g.status ? h(0, "error") : h(g.status, g.statusText) : h(ag[g.status] || g.status, g.statusText, "text" !== (g.responseType || "text") || "string" != typeof g.responseText ? {
                                binary: g.response
                            } : {
                                text: g.responseText
                    ...
                    ,
                    g.onload = d(),
                    b = g.onerror = g.ontimeout = d("error"),
                    void 0 !== g.onabort ? g.onabort = b : g.onreadystatechange = function() {
    ...
    b4.ajaxPrefilter("json jsonp", function(c, j, f) {
        var h, d, g, b = !1 !== c.jsonp && (cr.test(c.url) ? "url" : "string" == typeof c.data && 0 === (c.contentType || "").indexOf("application/x-www-form-urlencoded") && cr.test(c.data) && "data");
        if (b || "jsonp" === c.dataTypes[0]) {
            return h = c.jsonpCallback = bs(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback,
            b ? c[b] = c[b].replace(cr, "$1" + h) : !1 !== c.jsonp && (c.url += (aM.test(c.url) ? "&" : "?") + c.jsonp + "=" + h),
            c.converters["script json"] = function() {
                return g || b4.error(h + " was not called"),
                g[0]
            }
            ,
            c.dataTypes[0] = "json",
            ...
            ,
            f.always(function() {
                void 0 === d ? b4(aw).removeProp(h) : aw[h] = d,
                c[h] && (c.jsonpCallback = j.jsonpCallback,
                cE.push(h)),
                g && bs(d) && d(g[0]),
                g = d = void 0
            }),
    ...
    cF.createHTMLDocument = ((cl = aI.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === cl.childNodes.length),
    b4.parseHTML = function(a, g, c) {
        return "string" != typeof a ? [] : ("boolean" == typeof g && (c = g,
        g = !1),
        g || (cF.createHTMLDocument ? ((f = (g = aI.implementation.createHTMLDocument("")).createElement("base")).href = aI.location.href,
        g.head.appendChild(f)) : g = aI),
        d = !c && [],
        (b = bA.exec(a)) ? [g.createElement(b[1])] : (b = cB([a], g, d),
        d && d.length && b4(d).remove(),
        b4.merge([], b.childNodes)));
        var f, b, d
    }
    ,
    b4.fn.load = function(c, k, f) {
        var h, d, g, b = this, j = c.indexOf(" ");
        return -1 < j && (h = cq(c.slice(j)),
        c = c.slice(0, j)),
        bs(k) ? (f = k,
        ...
        0 < b.length && b4.ajax({
            ...
            g = arguments,
            b.html(h ? b4("<div>").append(b4.parseHTML(a)).find(h) : a)
    ...
    b4.offset = {
        setOffset: function(g, w, m) {
            ...
            "static" === k && (g.style.position = "relative"),
            v = d.offset(),
            p = b4.css(g, "top"),
            x = b4.css(g, "left"),
            ("absolute" === k || "fixed" === k) && -1 < (p + x).indexOf("auto") ? (b = (q = d.position()).top,
            j = q.left) : (b = parseFloat(p) || 0,
            j = parseFloat(x) || 0),
            bs(w) && (w = w.call(g, m, b4.extend({}, v))),
            null != w.top && (h.top = w.top - v.top + b),
            null != w.left && (h.left = w.left - v.left + j),
            "using"in w ? w.using.call(g, h) : ("number" == typeof h.top && (h.top += "px"),
    ...
    b4.fn.extend({
        offset: function(d) {
            ...
            var a, b, c = this[0];
            return c ? c.getClientRects().length ? (a = c.getBoundingClientRect(),
        ...
        position: function() {
            if (this[0]) {
                ...
                if ("fixed" === b4.css(d, "position")) {
                    ...
                    a && a !== d && 1 === a.nodeType && ((b = b4(a).offset()).top += b4.css(a, "borderTopWidth", !0),
                    b.left += b4.css(a, "borderLeftWidth", !0))
                }
                return {
    ...
    b4.each({
        ...
        b4.fn[c] = function(d) {
            return aa(this, function(f, i, g) {
                var h;
                if (cz(f) ? h = f : 9 === f.nodeType && (h = f.defaultView),
                void 0 === g) {
                    return h ? h[a] : f[i]
                }
    ...
    b4.each(["top", "left"], function(a, b) {
        b4.cssHooks[b] = ab(cF.pixelPosition, function(c, d) {
            if (d) {
                return d = aq(c, b),
                bw.test(d) ? b4(c).position()[b] + "px" : d
            }
        })
    }),
    b4.each({
        ...
        b4.each({
            ...
            b4.fn[a] = function(f, j) {
                ...
                return aa(this, function(i, m, k) {
                    var l;
                    return cz(i) ? 0 === a.indexOf("outer") ? i["inner" + b] : i.document.documentElement["client" + b] : 9 === i.nodeType ? (l = i.documentElement,
                    Math.max(i.body["scroll" + b], l["scroll" + b], i.body["offset" + b], l["offset" + b], l["client" + b])) : void 0 === k ? b4.css(i, m, g) : b4.style(i, m, k, g)
                }, c, h ? f : void 0, h)
            }
        })
    }),
    ...
    b4.proxy = function(a, f) {
        ...
        a = c),
        bs(a)) {
            return d = b3.call(arguments, 2),
            (b = function() {
                return a.apply(f || this, d.concat(b3.call(arguments)))
            }
            ).guid = a.guid = a.guid || b4.guid++,
            b
        }
    }
    ,
    ...
    ,
    b4.isArray = Array.isArray,
    b4.parseJSON = JSON.parse,
    b4.nodeName = ai,
    b4.isFunction = bs,
    b4.isWindow = cz,
    b4.camelCase = cA,
    ...
    return b4.noConflict = function(a) {
        return aw.$ === b4 && (aw.$ = bW),
        a && aw.jQuery === b4 && (aw.jQuery = cK),
        b4
    }
    ,
    "undefined" == typeof aH && (aw.jQuery = aw.$ = b4),
    b4
});
